...
let CommentsController = (() => {
    let _classDecorators = [Controller('posts/:postId/comments')];
    let _classDescriptor;
    let _classExtraInitializers = [];
    let _classThis;
    let _instanceExtraInitializers = [];
    let _findByPost_decorators;
    ...
    var CommentsController = class {
        ...
        static {
            ...
            _findByPost_decorators = [Get()];
            _create_decorators = [Post(), UseGuards(JwtAuthGuard)];
            _toggleLike_decorators = [Post(':commentId/like'), UseGuards(JwtAuthGuard)];
            _delete_decorators = [Delete(':commentId'), UseGuards(JwtAuthGuard)];
            __esDecorate(this, null, _findByPost_decorators, { kind: "method", name: "findByPost", static: false, private: false, access: { has: obj => "findByPost" in obj, get: obj => obj.findByPost }, metadata: _metadata }, null, _instanceExtraInitializers);
        ...
        commentsService = __runInitializers(this, _instanceExtraInitializers);
