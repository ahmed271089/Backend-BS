...
let ReportsController = (() => {
    let _classDecorators = [Controller('reports'), UseGuards(JwtAuthGuard)];
...
let AdminReportsController = (() => {
    let _classDecorators = [Controller('admin/reports'), UseGuards(JwtAuthGuard, RolesGuard), Roles('ADMIN')];
    let _classDescriptor;
    let _classExtraInitializers = [];
    let _classThis;
    let _instanceExtraInitializers = [];
    ...
    var AdminReportsController = class {
        static { _classThis = this; }
        static {
            const _metadata = typeof Symbol === "function" && Symbol.metadata ? Object.create(null) : void 0;
            _listPending_decorators = [Get()];
            ...
            __esDecorate(null, _classDescriptor = { value: _classThis }, _classDecorators, { kind: "class", name: _classThis.name, metadata: _metadata }, null, _classExtraInitializers);
            AdminReportsController = _classThis = _classDescriptor.value;
            if (_metadata) Object.defineProperty(_classThis, Symbol.metadata, { enumerable: true, configurable: true, writable: true, value: _metadata });
            __runInitializers(_classThis, _classExtraInitializers);
        }
        reportsService = __runInitializers(this, _instanceExtraInitializers);
    ...
    return AdminReportsController = _classThis;
})();
export { AdminReportsController };
